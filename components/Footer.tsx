...
const footerColumns: {
  ...
  },
  {
    heading: "Explore",
    links: [
      { href: "/abhijeetsingh/dsa", label: "DSA" },
      { href: "/abhijeetsingh/ai-ml", label: "AI & ML" },
      { href: "/abhijeetsingh/daa-design-and-analysis", label: "DAA" },
      { href: "/naveen09/react", label: "React" },
      { href: "/naveen09/nodejs", label: "Node.js" },
      { href: "/divyasachan/sql", label: "SQL" },
      { href: "/adarshkashyap/dbms", label: "DBMS" },
    ],
  },
  {
    heading: "Community",
    links: [
      { href: "/abhijeetsingh", label: "Abhijeet Singh" },
      { href: "/divyasachan", label: "Divya Sachan" },
      { href: "/vikashkumar", label: "Vikash Kumar" },
      { href: "/naveen09", label: "Naveen" },
      { href: "/gyan-prakash", label: "Gyan Prakash" },
      { href: "/adarshkashyap", label: "Adarsh" },
    ],
  },
];
