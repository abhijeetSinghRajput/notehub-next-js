        ...
        >
          ...
          {weeks.map((week, wi) =>
            week.contributionDays.map((day) => {
              const x = wi * STEP;
              const y =
                MONTH_LABEL_HEIGHT + week.contributionDays.indexOf(day) * STEP;
              return (
                <rect
                  key={day.date}
                  x={x}
...
export default function UserPageStatic({
  ...
  return (
    <div id="static-profile" className="p-4 pt-0">
      <div className="border-x">
        {/* ── Profile Card ── */}
        <div className="screen-line-bottom">
          <div className="max-w-3xl mx-auto overflow-hidden bg-card text-card-foreground">
            {/* Cover */}
                    ...
                    {user.skills && user.skills.length > 0 && (
                      <div className="flex flex-wrap gap-2 mt-4">
                        {user.skills.map((skill: string) => {
                          const devicon =
                            devicons[
                              skill.toLowerCase() as keyof typeof devicons
                            ];
                          return (
                            <Badge
                              key={skill}
        ...
        {collections.length > 0 && (
          <>
            ...
            <div className="screen-line-top">
              <h2 className="screen-line-bottom ml-4 font-heading text-3xl/none font-medium tracking-tight py-4">
                Collections
              </h2>
