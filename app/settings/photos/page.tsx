    ...
    <div className="p-4 pt-6 max-w-3xl mx-auto">
      ...
      <div className="space-y-10">
        ...
        <div className="space-y-4">
          <SectionDivider icon={User} label="PROFILE PHOTO" />
          ...
          <div className="flex flex-col sm:flex-row gap-8 items-start sm:items-center">
            <button
              ...
              onClick={() =>
                setSelectedImage(authUser?.avatar || "/avatar.svg")
              }
            ...
            <div className="space-y-6">
              <div className="space-y-1">
                ...
                <p className="text-muted-foreground text-sm">
                  ...
                  It&apos;s shown on your profile and helps others recognise
                  you.
                </p>
              </div>
        ...
        {/* ── COVER SECTION ── */}
        <div className="space-y-4">
          <SectionDivider icon={ImageIcon} label="PROFILE COVER" />
          ...
          <div className="flex flex-col gap-6 items-start">
            <button
              ...
              onClick={() =>
                setSelectedImage(authUser?.cover || "/placeholder.svg")
              }
