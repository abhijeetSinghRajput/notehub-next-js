...
import { Trash, Ban, CheckCircle, Shield, User as UserIcon } from "lucide-react";
const PAGE_SIZE = 50;
      ...
      <Card className="border-none shadow-none bg-background sm:bg-card sm:border sm:shadow-md relative">
        ...
        <CardContent className="space-y-4 p-0 sm:p-6 sm:pt-0">
          ...
          {selectedIds.length > 0 && (
            <div className="flex flex-wrap items-center gap-2 p-3 bg-muted/50 border rounded-md sticky top-0 z-10 shadow-sm transition-all animate-in fade-in slide-in-from-top-2">
